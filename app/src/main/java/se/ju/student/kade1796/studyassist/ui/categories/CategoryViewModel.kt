...
class CategoryViewModel : ViewModel() {
    ...
    fun getCategoryList(): ArrayList<Categories> {
        ...
        var list = mutableListOf(
            ...
            Categories("Course Material", "course", 0, R.drawable.image_course_material),
            Categories("Exchange Studies", "exchange", 0, R.drawable.image_exchange),
            Categories("Other", "other", 0, R.drawable.image_other)
        )
